...
<div style="text-align:center;">
  ...
  <figcaption><b>Getting Started Part 2</b>: Follow along to learn about the Sample Web UI and the various profiles: CIRA Configs, AMT Profiles, and Domain Profiles. <b>Additional Resources: </b><a href="../../Concepts/security.md#authentication-credentials">Passwords and What They Mean</a>, <a href="../../Concepts/remoteProvisioning.md">Provisioning Certificates</a>, and <a href="../../Reference/MEBX/dnsSuffix.md">Setting a DNS Suffix via MEBX</a></figcaption>
</div>
