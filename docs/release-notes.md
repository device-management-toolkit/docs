...
Administrators can now export AMT audit and event logs in JSON format, enabling easier compliance reporting, troubleshooting, and security analysis.
<br>
...
:material-new-box: **Preview feature: OIDC OAuth2 support**

This release introduces preliminary support for the OAuth 2.0/OIDC authentication framework, enabling organizations to begin testing integration with their existing identity providers. Detailed documentation will be available soon.
<br>
...
!!! note "Note From the Team"
    ...
    We’re excited to release this MVP and remain committed to enhancing Console with new features and improvements. Up next: One-Click Recovery (OCR) support, followed by updates for the transition from Open AMT Cloud Toolkit to the Device Management Toolkit, including reference renaming and documentation revisions.
