...
| [disable-operational-state](#disable-operational-state) | Disable AMT operational state.                                                    |
...
| [enable-operational-state](#enable-operational-state)   | Enable AMT operational state.                                                    |
...
Enables AMT operational state. 

```
rpc configure enable-operational-state
```
...
Disables AMT operational state. 

```
rpc configure disable-operational-state
```
