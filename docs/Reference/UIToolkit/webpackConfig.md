...
!!! note
    This page documents the v4 Webpack-based build configuration. In v5, the UI Toolkit React uses **Rollup** for bundling and ships pre-built ESM and CJS modules. Custom Webpack configuration is no longer required. See the [UI Toolkit React Tutorial](../../Tutorials/uitoolkitReact.md) for the current setup guide.

## v5 Build System

The UI Toolkit React v5 uses Rollup and ships as:

- **ESM**: `dist/index.esm.js`
- **CJS**: `dist/index.cjs.js`
- **Types**: `dist/index.d.ts`

No custom build configuration is needed. Simply install the package and import the components:

``` typescript
import { KVM, Sol, AttachDiskImage } from '@device-management-toolkit/ui-toolkit-react'
```

For development, the example application uses [Vite](https://vitejs.dev/):
...
## v4 Webpack Configuration (Legacy)

??? note "v4 Webpack Configuration (click to expand)"
